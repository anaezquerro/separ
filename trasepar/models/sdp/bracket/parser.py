...
from trasepar.data import SDP, Tokenizer, CharacterTokenizer, PretrainedTokenizer, EnhancedCoNLL
from trasepar.structs import Arc, adjacent_from_arcs
from trasepar.utils import flatten, Config, parallel, acc, avg, pad2D, create_mask, SemanticMetric
from trasepar.parser import Parser
from trasepar.models.sdp.labeler import SemanticLabeler
from trasepar.models.sdp.bracket.model import BracketSemanticModel
...
class BracketSemanticParser(Parser):
    ...
    def control_step(
        ...
        loss, embed, bracket_preds, s_rel = self.model.control(inputs[0], inputs[1:], brackets, rels, matrices, mask)
    ...
    def build(
        ...
        **_
        ...
        return cls(model, input_tkzs, [bracket_tkz, rel_tkz], k, root_rel, device)
