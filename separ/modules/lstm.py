...
class BixLSTM(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.left2right = nn.ModuleList([xLSTM(input_size, hidden_size//2, num_layers=1, **kwargs)])
        self.right2left = nn.ModuleList([xLSTM(input_size, hidden_size//2, num_layers=1, **kwargs)])
