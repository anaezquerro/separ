...
from separ.utils import flatten, Config, parallel, DependencyMetric, create_mask, avg, acc
from separ.structs import Arc, forms_cycles, candidates_no_cycles
from separ.models.dep.bit4.model import Bit4DependencyModel
...
class Bit4DependencyParser(Parser):
    ...
    def build(
        ...
        **_
        ...
        bit_tkz.train(*flatten(parallel(labeler.encode, data, name=f'{cls.NAME}[encode]')))
        ...
        return cls(model, input_tkzs, [bit_tkz, rel_tkz], device)
